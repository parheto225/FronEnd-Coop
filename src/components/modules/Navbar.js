...
import logoagm from '../assets/img/logo_akidompro.png';
          ...
          <div className="navbar-logo">
            ...
            <Link className="navbar-brand me-1 me-sm-3" to="/dash-coop/">
              <div className="d-flex align-items-center">
                <div className="d-flex align-items-center">
                    <img src={logoagm} alt="phoenix" style={{width: "230px", height: "170px"}} />
                </div>
              </div>
            </Link>
          </div>
              ...
              <a className="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                {user && user.id === 8 ? 
                  <div className="avatar avatar-l ">
                    <img className="rounded" src={Logo_Agrial} alt="" style={{width: "230px", height: "70px", marginLeft: "-200px", marginTop: "-15px"}} />
                  </div> :
                  ""
                }
                {user && user.id === 17 ? 
